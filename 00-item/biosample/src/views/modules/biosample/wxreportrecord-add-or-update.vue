<template>
  <el-dialog
    ...
    <el-form-item label="0 未发送成功，1 发送成功" prop="sendSuccess">
      <el-input v-model="dataForm.sendSuccess" placeholder="0 未发送成功，1 发送成功"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          sendSuccess: [
            { required: true, message: '0 未发送成功，1 发送成功不能为空', trigger: 'blur' }
          ]
        }
      }
    },
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/biosample/wxreportrecord/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.dataForm.sampleId = data.wxReportRecord.sampleId
                this.dataForm.sampleCode = data.wxReportRecord.sampleCode
                this.dataForm.sampleType = data.wxReportRecord.sampleType
                this.dataForm.sampleTypeName = data.wxReportRecord.sampleTypeName
                this.dataForm.collectAddress = data.wxReportRecord.collectAddress
                this.dataForm.collectAddressName = data.wxReportRecord.collectAddressName
                this.dataForm.receiveDate = data.wxReportRecord.receiveDate
                this.dataForm.sourceId = data.wxReportRecord.sourceId
                this.dataForm.idCard = data.wxReportRecord.idCard
                this.dataForm.name = data.wxReportRecord.name
                this.dataForm.sex = data.wxReportRecord.sex
                this.dataForm.age = data.wxReportRecord.age
                this.dataForm.telephone = data.wxReportRecord.telephone
                this.dataForm.dnaConsi = data.wxReportRecord.dnaConsi
                this.dataForm.extractTime = data.wxReportRecord.extractTime
                this.dataForm.extractUserId = data.wxReportRecord.extractUserId
                this.dataForm.extractUser = data.wxReportRecord.extractUser
                this.dataForm.dnaApplyTime = data.wxReportRecord.dnaApplyTime
                this.dataForm.dnaApplyUserId = data.wxReportRecord.dnaApplyUserId
                this.dataForm.dnaApplyUser = data.wxReportRecord.dnaApplyUser
                this.dataForm.dnaCreateOn = data.wxReportRecord.dnaCreateOn
                this.dataForm.dnaCreateUserId = data.wxReportRecord.dnaCreateUserId
                this.dataForm.dnaCreateBy = data.wxReportRecord.dnaCreateBy
                this.dataForm.smn17 = data.wxReportRecord.smn17
                this.dataForm.qcValue17 = data.wxReportRecord.qcValue17
                this.dataForm.result17 = data.wxReportRecord.result17
                this.dataForm.smn18 = data.wxReportRecord.smn18
                this.dataForm.qcValue18 = data.wxReportRecord.qcValue18
                this.dataForm.result18 = data.wxReportRecord.result18
                this.dataForm.qcValue = data.wxReportRecord.qcValue
                this.dataForm.result = data.wxReportRecord.result
                this.dataForm.detectTime = data.wxReportRecord.detectTime
                this.dataForm.detectUserId = data.wxReportRecord.detectUserId
                this.dataForm.detectUser = data.wxReportRecord.detectUser
                this.dataForm.applyTime = data.wxReportRecord.applyTime
                this.dataForm.applyUserId = data.wxReportRecord.applyUserId
                this.dataForm.applyUser = data.wxReportRecord.applyUser
                this.dataForm.createOn = data.wxReportRecord.createOn
                this.dataForm.createUserId = data.wxReportRecord.createUserId
                this.dataForm.createBy = data.wxReportRecord.createBy
                this.dataForm.modifiedOn = data.wxReportRecord.modifiedOn
                this.dataForm.modifiedUserId = data.wxReportRecord.modifiedUserId
                this.dataForm.modifiedBy = data.wxReportRecord.modifiedBy
                this.dataForm.status = data.wxReportRecord.status
                this.dataForm.deleted = data.wxReportRecord.deleted
                this.dataForm.sendSuccess = data.wxReportRecord.sendSuccess
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/biosample/wxreportrecord/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
              data: this.$http.adornData({
                ...
                'sendSuccess': this.dataForm.sendSuccess
              })
            }).then(({data}) => {
              if (data && data.code === 0) {
                this.$message({
